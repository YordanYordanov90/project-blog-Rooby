...
export default function MainFooter(props: MainFooterProps) {
  return (
    <footer {...props} className='border-t py-2'>
      <div className="container max-w-[1140px] mx-auto flex md:flex-row flex-col justify-between">
        <section>
         ...
         <p className='line-clamp-3 sm:line-clamp-2 md:line-clamp-4 pt-7'>
          We built an elegant solution.<br/> Our team created a fully integrated <br/> sales and marketing solution for SMBs
         </p>
      ...
      <div className="container border-t flex items-center justify-between m-auto py-10 max-w-[1140px]"> 
    ...
    <select className='text-black border rounded-lg px-6' name="English" id="">English</select>
  </div>
    </footer>
  )
}