    ...
    <div className="max-w-[1140px] mx-auto px-5 my-32 space-y-28 max-lg:space-y-16">
      <div className="relative flex justify-between items-center max-sm:py-5 lg:pt-12 border-t-[2px] border-placeholder-grey max-lg:flex-col max-lg:gap-10">
        <div className="max-w-[30rem]">
          ...
          <ul className="mt-5 space-y-4 text-lg">
            <li className="flex gap-5">
              <div>
                <Image height={24} width={24} src="/ic_done.png" alt="Done icon" />
              </div>
            ...
            <li className="flex gap-5">
              <div>
                <Image height={30} width={30} src="/ic_done.png" alt="Done icon" />
              </div>
        ...
        <div className="relative">
          <Image src="/Image12.png" alt="Sales Image" width={500} height={500} />
        </div>
      </div>
      <div className="relative flex justify-between items-center max-sm:py-5 lg:pt-12 border-t-[2px] border-placeholder-grey max-lg:flex-col max-lg:gap-10">
        <div className="relative">
          <Image src="/Image13.png" alt="Marketing Image" width={500} height={500} />
        </div>
        <div className="max-w-[30rem]">
          <div className="px-3 py-1 inline-block text-sm font-bold bg-[#FFE377] rounded">
            MARKETING
      ...
      <div className="relative flex justify-between items-center max-sm:py-5 lg:pt-12 border-t-[2px] border-placeholder-grey max-lg:flex-col max-lg:gap-10">
        ...
        <div className="relative">
          <Image src="/Image14.png" alt="Service Image" width={500} height={500} />
        </div>
      </div>
    </div>
  );
