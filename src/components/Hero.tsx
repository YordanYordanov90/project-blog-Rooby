    ...
    <section className="bg-[#F4F4F4] overflow-hidden">
        <div className="max-w-[1180px] mx-auto px-5 pt-[70px] pb-[90px] relative max-xl:flex max-xl:flex-col max-xl:gap-[70px] max-xl:text-center">
            <div className="max-xl:flex max-xl:flex-col max-xl:items-center">
                ...
                <p className="max-w-[478px] mt-5 text-lg leading-7">An awesome & powefull tools for your business, increase business revenue with enterprise-grade links built
            to acquire and engage cutomers.</p>
            <form className="mt-[60px] max-w-[457px] w-full h-[72px] relative">
                <input  className="w-full h-full px-6 rounded-xl border-[#EDEDED] border-[1px] placeholder:text-lg placeholder:font-medium placeholder:text-[#787878]"
